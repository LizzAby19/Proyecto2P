...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center">Ciudad</h1>
        <div class="container">
            <a class="btn btn-success" href="addCiu.jsp">Agregar Nuevo</a>
            <br><br>
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><%= art.getCodigo_ciu()%></td>
                        <td class="text-center"><%= art.getNombre_ciu()%></td>
                        <td class="text-center">
                            <a class="btn btn-warning" href="ControladorCiu?accion=editar&id=<%= art.getId_ciu()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorCiu?accion=eliminar&id=<%= art.getId_ciu()%>">Remove</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
